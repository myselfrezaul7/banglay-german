    ...
    return (
        <div className="glass-panel p-8 md:p-10">
            ...
            <ScrollReveal delay={0.1} direction="up">
                ...
                <button onClick={handleGoogle} disabled={isSubmitting} className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-[1.25rem] border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700/80 hover:border-slate-300 dark:hover:border-slate-600 transition-all duration-300 mb-6 group active:scale-[0.98] shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed">
                    ...
                    <span className="font-semibold text-slate-700 dark:text-slate-200">{isSubmitting ? 'Connecting...' : 'Continue with Google'}</span>
                </button>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <motion.div layout className="pt-2">
                        <button type="submit" disabled={isSubmitting} className="w-full px-4 py-4 rounded-[1.25rem] bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold shadow-lg shadow-blue-600/25 hover:shadow-blue-600/40 transition-all duration-300 active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed">
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden bg-slate-50 dark:bg-slate-950">
            ...
            <ScrollReveal direction="up" duration={0.8} className="w-full max-w-md relative z-10">
                <Suspense fallback={<div className="glass-panel p-10 text-center text-slate-500">Loading form...</div>}>
                    <LoginForm />
                </Suspense>
            </ScrollReveal>
        </div>
