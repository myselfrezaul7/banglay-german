...
import { Trophy, Flame, Star, BookOpen, Target, LogOut, Medal, Diamond, Crown, Zap } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-24 transition-opacity duration-500 relative overflow-x-hidden">
            ...
            <div className="max-w-5xl mx-auto px-6 pt-24 md:pt-32 relative z-10">
                ...
                {/* Hero Profile Card */}
                <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-2xl rounded-[3rem] p-8 md:p-12 border border-slate-200/50 dark:border-slate-800/50 shadow-2xl shadow-indigo-900/5 mb-8 animate-fadeInUp">
                ...
                {/* Key Statistics Grid */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-12 animate-fadeInUp" style={{ animationDelay: '0.1s' }}>
                ...
                {/* Quick Actions Panel */}
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[3rem] p-8 md:p-12 text-white shadow-2xl shadow-blue-900/20 relative overflow-hidden animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
